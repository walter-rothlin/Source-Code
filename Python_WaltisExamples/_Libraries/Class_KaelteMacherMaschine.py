...
class KaelteMacherMaschine:
   ...
   def __init__(self, piPlateAdr1 = 1, piPlateAdr2 = 2, piRelayAdr = 3, simulate = False):
      ...
      self.compressor_1_On_Relais      = 3
      self.compressor_2_On_Relais      = 4
      ...
      self.environmentTempSensorP1000 = TemperaturSensorPT1000("Umgebungs-Temperatur PT1000",1,4,Temp_P1 = 25, U_P1 = 3.196, Temp_P2 = 48, U_P2 = 3.736)
      self.wasserTempSensor           = TemperaturSensorDigital("Wasser-Temperatur",2,0)
      self.wasserTempSensorP1000      = TemperaturSensorPT1000("Wasser-Temperatur PT1000",1,3,Temp_P1 = 25, U_P1 = 3.196, Temp_P2 = 48, U_P2 = 3.736)
   ...
   def setSpeedComp(self, verdichterNr, speed, verbal = True):
      ...
      DAQC.setDAC(self.piPlateAdr1,int(verdichterNr) - 1,speed * 4.092 / 100)
   ...
   def setMixingValve(self, valvePosition, verbal = False):
      ...
      DAQC.setDAC(self.piPlateAdr2,0,valvePosition * 4.092 / 100)
