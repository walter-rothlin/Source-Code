...
#      ++ gute Anwendungsfälle implementiert
#      + Eingaben werden überprüft und falsche Eingaben führen nicht zu einem Absturtz
#
# Class Design und Implementation:
#      + Design-Diagramm vorhanden
#      + Notwendige (__eq__ __str__ __eq__) Methoden vorhanden
#      - __init__ nicht alle relevanten Argumente und mit funktionierenden Default Werten
#      - Beinahe alle Instance Variablen sind public
#      - Kein docStrings für die Beschreibung der Interfaces (Methoden / Classes)
#
# Test:
