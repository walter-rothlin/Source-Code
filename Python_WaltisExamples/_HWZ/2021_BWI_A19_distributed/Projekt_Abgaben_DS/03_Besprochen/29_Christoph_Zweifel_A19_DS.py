...
#      - Funktioniert auch nach installation der Module nicht
#      - Import nicht gebrauchter Module
#
# Class Design und Implementation:
#      - Kein class-Diagramm
#      - docString Inhalt falsche Fauchausdrücke (funktion und Klasse!)
#      - Notwendige (__eq__ __str__ __eq__) Methoden nicht in beiden Klassen vorhanden
#      - __init__ ohne parameter
...
#      - Klassenhierarchie unklar wieso
#
# Test:
