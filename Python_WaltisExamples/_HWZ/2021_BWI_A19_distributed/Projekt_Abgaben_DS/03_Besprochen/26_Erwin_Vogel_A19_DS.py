...
#      + Funktioniert
#      + User-Eingaben möglich und unsinnige Eingaben werden abgefangen
#      - Eingabe des Messungsintervalles wird nicht verwendet
#
# Class Design und Implementation:
#      - Kein Class-Diagramm vorhanden
#      -- Klasse representiert nicht eine Wetterstation, sondern nur eine Exception davon
#      + Notwendige (__init__ __str__ __eq__) Methoden vorhanden
#      - __init__ unnötige parameter und die relevanten fehlen haben; keine Default values
...
#
# Test:
#      + Test (positive und negative) sind dokumentiert
#      - Keine Tests wieder verwendbar
#
# Note: 4.5
#
# Fragen:
