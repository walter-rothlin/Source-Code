...
#      + Diagramm stimmt grösstenteils mit Code überein (Vererbungspfeil zeigt auf falsche Seite)
#      + Notwendige (__init__ __str__ __eq__) Methoden vorhanden
#      + __init__  alle parameter haben sinnvolle Default values
...
#      - str ruft nicht toString auf
#
# Test:
#      + Unit-Test (positive) implementiert
#
# Note: 5.0
#
# Fragen:
...
#    Was ist unterschied zwischen __str__ und toString?
# ------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------
