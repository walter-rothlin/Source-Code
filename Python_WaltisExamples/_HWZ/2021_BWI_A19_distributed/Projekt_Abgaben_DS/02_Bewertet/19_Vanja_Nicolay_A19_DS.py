...
#      - sinnlose Usereingaben führen zum Absturtz
#
# Class Design und Implementation:
#      + Diagramm stimmt mit Code überein
#      + Notwendige (__eq__ __str__ __eq__) Methoden vorhanden
#      + __init__ wichtigste parameter und die relevanten Default values vorhanden
#      - __init__ macht keinen Request und somit kann die Gültigkeit des Ortes nicht bei der Instanzierung ueberprüft werden
#      -- Kein Exception Handling in den Klassen oder in der Applikation eingebaut
# Test:
#     -- Keine wiederverwendbaren Tests (positive oder negative) implementiert
#
# Note: 5.0
#
# Fragen:
