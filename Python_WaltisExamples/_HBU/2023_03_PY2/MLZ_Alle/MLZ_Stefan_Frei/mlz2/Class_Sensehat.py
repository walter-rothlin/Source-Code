...
class MySenseHat(SenseHat):
    ...
    def set_pixel(self, x, y, r=255, g=0, b=0, pixel_color=None):
        ...
        if pixel_color is not None:
            if pixel_color == 'red':
                color_array = self.red
            elif pixel_color == 'green':
                color_array = self.green
            elif pixel_color == 'blue':
                color_array = self.blue
            elif pixel_color == 'yellow':
                color_array = self.yellow
            elif pixel_color == 'magenta':
                color_array = self.magenta
            elif pixel_color == 'cyan':
                color_array = self.cyan
            elif pixel_color == 'white':
                color_array = self.white
            elif pixel_color == 'grey':
                color_array = self.grey
            elif pixel_color == 'black':
                color_array = self.black
            r = int(color_array[0])
            g = int(color_array[1])
            b = int(color_array[2])
...
if __name__ == '__main__':
    ...
    sense.set_pixel(1,1,pixel_color='cyan')
    sleep(3)
    sense.clear()