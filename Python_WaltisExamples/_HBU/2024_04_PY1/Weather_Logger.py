...
url_str = "https://api.openweathermap.org/data/2.5/weather?q=Uster&units=metric&lang=de&appid=144747fd356c86e7926ca91ce78ce170"
...
print("   Feuchtikeit:", jsonResponse['main']['humidity'])
print("   Beschreibung:", jsonResponse['weather'][0]['description'])
