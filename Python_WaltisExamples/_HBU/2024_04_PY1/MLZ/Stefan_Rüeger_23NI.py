...
5. Nur absolut Notwendiges ist public (2 Punkte)                                        1 (z.B. logLength(), delimiter müssen nicht public sein
...
11. ChangesOnly implementiert                                                           0 (funktioniert nicht! last wird zuerst gesetzt und nachher verglichen!! Zeile 178)
...
delimiter       = ";"
file_path       = "./"
file_name       = "Stefan_Rüeger_log.txt"
max_entries     = 6
only_changes    = False
append_log      = False
