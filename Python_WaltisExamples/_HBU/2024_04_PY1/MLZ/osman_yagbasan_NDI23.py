...
5. Nur absolut Notwendiges ist public (2 Punkte)                                        0  (z.B. instance variablen, write_to_file() sind public)
...
if __name__ == '__main__':
    #Logger 
    logger = Logger(file_path=".", file_name="osman_yagbasan_log.txt", delimiter=";", append=False)
