...
5. Nur absolut Notwendiges ist public (2 Punkte)                                        1
...
+ sehr guter Design und einfache Ausbaumöglichkeit
- kein heartbeat
- Strategie "OnlyChanges" nicht implementiert
- Strategie "FixedSlices" nicht implementiert
...
#Logger erstellen
weather_Logger = Logger(file_path=".", file_name="Janik_Hoffmann_log.txt", header_line= ["Timestamp","Level","Ort","q [%]","p_Low [bar]"], append=False)
