...
if __name__ == '__main__':
    ...
    log_all = True
    weather_fetcher = WeatherFetcher(appid, ort, filename='Claudio_Monti_log.txt', delimiter=';', max_entries=10, sample_time=3, log_all=log_all, overwrite=overwrite)
