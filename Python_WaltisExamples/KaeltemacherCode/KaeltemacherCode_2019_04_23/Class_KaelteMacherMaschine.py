...
class KaelteMacherMaschine:
   ...
   # Digital Inputs
   def getSpannungVerdichter_1_ok(self):
      measure = DAQC.getDINbit(self.piPlateAdr,0)
      if (measure == 1):
          retVal = True
      else:
          retVal = False
      print("getSpannungVerdichter_1_ok  :", measure,"  (",retVal,")")
      return retVal

   def getSpannungVerdichter_2_ok(self):
      measure = DAQC.getDINbit(self.piPlateAdr,1)
      if (measure == 1):
          retVal = True
      else:
          retVal = False
      print("getSpannungVerdichter_2_ok    :", measure,"  (",retVal,")")
      return retVal
