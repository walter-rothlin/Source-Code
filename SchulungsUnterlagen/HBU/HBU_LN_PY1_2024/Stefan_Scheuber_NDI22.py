...
class Logger:
    ...
    #Konstruktor
    #==================================================
    def __init__(self, file_path = '', file_name= 'logFile.txt', maxEntrys = 100, onlyChanges = False, append = False, delimiter = ';', titel = '', formatTimeStamp = "%d.%m.%Y %H:%M:%S"):
        #Instanz Variable
...
while activProperties:
  ...
  print (properties)
  auswahl = input_int('Do you want to change some properites? \n')
  ...
  if auswahl == 1:
    ...
    clearConsol()
    actualizationTime = input_float('Please type the actualization time \n') 
    user_input = ''
