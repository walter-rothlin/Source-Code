...
# 24-Sep-2025   Christian Meier Fixed code so it passes all tests
# ------------------------------------------------------------------
import math
...
class Fraction:
    ...
    def __init__(self, zaehler=0, nenner=1, bruch=None, bruch_str=None):
        ...
        try:
            ...
            zaehler = 0
        self.zaehler = round(zaehler)
        self.nenner = round(nenner)
    ...
    def shorten(self, divisor=None):
        ...
        if divisor > 0:
            ...
            elif self.__zaehler < 0 or self.__nenner < 0:
                self.__zaehler = -abs(self.__zaehler)
                self.__nenner = abs(self.__nenner)
        return self
