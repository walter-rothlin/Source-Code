...
-- 30-Jun-2026   David Egeler        LN2
-- ---------------------------------------------------------------------------------
-- -------------- Hier bitte ihre persönlichen Angaben erfassen --------------------

SET @Candidate_Firstname  := 'David';
SET @Candidate_Name       := 'Egeler';
SET @Class                := 'BWI-A24';
...
UPDATE `personen`
SET `Hausnummer` = NULLIF(TRIM(REGEXP_SUBSTR(`Strasse`, '[0-9]+[a-zA-Z]?$')), ''),
